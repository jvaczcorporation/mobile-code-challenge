...
class Mocks {
  static PokemonEntity get pokemonEntityMock => const PokemonEntity(
        id: 1,
        name: "name",
        weight: 20,
        height: 10,
  ...
  static PokemonModel get pokemonModelMock => const PokemonModel(
        id: 1,
        name: "name",
        weight: 20,
        height: 10,
  ...
  static Map<String, dynamic> get pokemonToJsonMock => {
        "abilities": [
          {
            "ability": {
              "name": "overgrow",
